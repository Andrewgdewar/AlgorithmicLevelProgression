...
function ProgressionChanges(container) {
    if (config_json_1.default?.enableProgressionChanges) {
        ...
        for (let index = 0; index < numList.length; index++) {
            ...
            for (let k = 0; k < itemList.length; k++) {
                ...
                if (parent === AmmoParent) {
                    ...
                    if (!weightingAdjustmentItem.ammo.edit?.[item._props.Caliber]) {
                        weightingAdjustmentItem.ammo.edit = { ...weightingAdjustmentItem.ammo.edit, [item._props.Caliber]: {} };
                    }
