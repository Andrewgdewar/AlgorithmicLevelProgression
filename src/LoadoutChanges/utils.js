    ...
    exports.numList.forEach((num, index) => {
        ...
        const newItem = {
            ...
            generation: {
                ...
                "looseLoot": {
                    "min": config_json_1.default.removePMCLootForLootingBots ? [0, 0, 0, 0][index] : [0, 1, 2, 3][index],
                    "max": config_json_1.default.removePMCLootForLootingBots ? [1, 1, 1, 2] : [3, 5, 6, 8][index],
